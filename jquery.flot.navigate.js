...
(function(f){f.fn.drag=function(b,a,d){var e=typeof b=="string"?b:"",j=f.isFunction(b)?b:f.isFunction(a)?a:null;if(e.indexOf("drag")!==0)e="drag"+e;d=(b==j?a:d)||{};return j?this.bind(e,d,j):this.trigger(e)};var h=f.event,i=h.special,c=i.drag={defaults:{which:1,distance:0,not:":input",handle:null,relative:false,drop:true,click:false},datakey:"dragdata",noBubble:true,add:function(b){var a=f.data(this,c.datakey),d=b.data||{};a.related+=1;f.each(c.defaults,function(e){if(d[e]!==undefined)a[e]=d[e]})},
remove:function(){f.data(this,c.datakey).related-=1},setup:function(){if(!f.data(this,c.datakey)){var b=f.extend({related:0},c.defaults);f.data(this,c.datakey,b);h.add(this,"touchstart mousedown",c.init,b);this.attachEvent&&this.attachEvent("ondragstart",c.dontstart)}},teardown:function(){if(!(f.data(this,c.datakey)||{}).related){f.removeData(this,c.datakey);h.remove(this,"touchstart mousedown",c.init);c.textselect(true);this.detachEvent&&this.detachEvent("ondragstart",c.dontstart)}},init:function(b){if(!c.touched){var a=
b.data,d;if(!(b.which!=0&&a.which>0&&b.which!=a.which))if(!f(b.target).is(a.not))if(!(a.handle&&!f(b.target).closest(a.handle,b.currentTarget).length)){c.touched=b.type=="touchstart"?this:null;a.propagates=1;a.mousedown=this;a.interactions=[c.interaction(this,a)];a.target=b.target;a.pageX=b.pageX;a.pageY=b.pageY;a.dragging=null;d=c.hijack(b,"draginit",a);if(a.propagates){if((d=c.flatten(d))&&d.length){a.interactions=[];f.each(d,function(){a.interactions.push(c.interaction(this,a))})}a.propagates=
a.interactions.length;a.drop!==false&&i.drop&&i.drop.handler(b,a);c.textselect(false);c.touched?h.add(c.touched,"touchmove touchend",c.handler,a):h.add(document,"mousemove mouseup",c.handler,a);if(!c.touched||a.live)return false}}}},interaction:function(b,a){var d=f(b)[a.relative?"position":"offset"]()||{top:0,left:0};return{drag:b,callback:new c.callback,droppable:[],offset:d}},handler:function(b){var a=b.data;switch(b.type){case !a.dragging&&"touchmove":b.preventDefault();case !a.dragging&&"mousemove":if(Math.pow(b.pageX-
a.pageX,2)+Math.pow(b.pageY-a.pageY,2)<Math.pow(a.distance,2))break;b.target=a.target;c.hijack(b,"dragstart",a);if(a.propagates)a.dragging=true;case "touchmove":b.preventDefault();case "mousemove":if(a.dragging){c.hijack(b,"drag",a);if(a.propagates){a.drop!==false&&i.drop&&i.drop.handler(b,a);break}b.type="mouseup"}case "touchend":case "mouseup":default:c.touched?h.remove(c.touched,"touchmove touchend",c.handler):h.remove(document,"mousemove mouseup",c.handler);if(a.dragging){a.drop!==false&&i.drop&&
i.drop.handler(b,a);c.hijack(b,"dragend",a)}c.textselect(true);a.click===false&&a.dragging&&f.data(a.mousedown,"suppress.click",(new Date).getTime()+5);a.dragging=c.touched=false;break}},hijack:function(b,a,d,e,j){if(d){var p={event:b.originalEvent,type:b.type},n=a.indexOf("drop")?"drag":"drop",k,o=e||0,g,l;e=!isNaN(e)?e:d.interactions.length;b.type=a;b.originalEvent=null;d.results=[];do if(g=d.interactions[o])if(!(a!=="dragend"&&g.cancelled)){l=c.properties(b,d,g);g.results=[];f(j||g[n]||d.droppable).each(function(q,
m){l.target=m;b.isPropagationStopped=function(){return false};k=m?h.dispatch.call(m,b,l):null;if(k===false){if(n=="drag"){g.cancelled=true;d.propagates-=1}if(a=="drop")g[n][q]=null}else if(a=="dropinit")g.droppable.push(c.element(k)||m);if(a=="dragstart")g.proxy=f(c.element(k)||g.drag)[0];g.results.push(k);delete b.result;if(a!=="dropinit")return k});d.results[o]=c.flatten(g.results);if(a=="dropinit")g.droppable=c.flatten(g.droppable);a=="dragstart"&&!g.cancelled&&l.update()}while(++o<e);b.type=p.type;
b.originalEvent=p.event;return c.flatten(d.results)}},properties:function(b,a,d){var e=d.callback;e.drag=d.drag;e.proxy=d.proxy||d.drag;e.startX=a.pageX;e.startY=a.pageY;e.deltaX=b.pageX-a.pageX;e.deltaY=b.pageY-a.pageY;e.originalX=d.offset.left;e.originalY=d.offset.top;e.offsetX=e.originalX+e.deltaX;e.offsetY=e.originalY+e.deltaY;e.drop=c.flatten((d.drop||[]).slice());e.available=c.flatten((d.droppable||[]).slice());return e},element:function(b){if(b&&(b.jquery||b.nodeType==1))return b},flatten:function(b){return f.map(b,
function(a){return a&&a.jquery?f.makeArray(a):a&&a.length?c.flatten(a):a})},textselect:function(b){f(document)[b?"unbind":"bind"]("selectstart",c.dontstart).css("MozUserSelect",b?"":"none");document.unselectable=b?"off":"on"},dontstart:function(){return false},callback:function(){}};c.callback.prototype={update:function(){i.drop&&this.available.length&&f.each(this.available,function(b){i.drop.locate(this,b)})}};var r=h.dispatch;h.dispatch=function(b){if(b&&b.type&&f.data(this,"suppress."+b.type)-
(new Date).getTime()>0)f.removeData(this,"suppress."+b.type);else return r.apply(this,arguments)};var s=h.fixHooks.touchstart=h.fixHooks.touchmove=h.fixHooks.touchend=h.fixHooks.touchcancel={props:"clientX clientY pageX pageY screenX screenY".split(" "),filter:function(b,a){if(a){var d=a.touches&&a.touches[0]||a.changedTouches&&a.changedTouches[0]||null;d&&f.each(s.props,function(e,j){b[j]=d[j]})}return b}};i.draginit=i.dragstart=i.dragend=c})(jQuery);
